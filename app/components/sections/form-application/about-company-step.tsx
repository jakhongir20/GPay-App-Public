        ...
        <form className="w-full space-y-6">
          <div className="grid lg:grid-cols-3 gap-3">
            <div>
              <label
                className="mb-2 block text-base tracking-[-0.16px] text-white/60"
              >
                Фамилия <span className="text-text-primary">*</span>
              </label>
              <div className="relative">
                <input
            ...
            <div>
              <label
                className="mb-2 block text-base tracking-[-0.16px] text-white/60"
              >
                Имя <span className="text-text-primary">*</span>
              </label>
              <div className="relative">
                <input
                  placeholder={"Амирбек"}
            ...
            <div>
              <label
                className="mb-2 block text-base tracking-[-0.16px] text-white/60"
              >
                Отчество (при наличии) <span className="text-text-primary opacity-0">*</span>
              </label>
              <div className="relative">
                <input
          ...
          <div className="grid lg:grid-cols-2 gap-3">
            <div>
              <label
                className="mb-2 block text-base tracking-[-0.16px] text-white/60"
              >
                E-mail <span className="text-text-primary">*</span>
              </label>
              <div className="relative">
                <input
            ...
            <div>
              <label
                className="mb-2 block text-base tracking-[-0.16px] text-white/60"
              >
                Телефон <span className="text-text-primary">*</span>
              </label>
              <div className="relative">
                <input
                  placeholder={"+998"}
          ...
          <div>
            <label
              className="mb-2 block text-base tracking-[-0.16px] text-white/60"
            >
              Должность <span className="text-text-primary">*</span>
            </label>
            <div className="relative">
              <input
